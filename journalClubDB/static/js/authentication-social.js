// Hide conventional login at first
$(document).ready(function() {

  $(".display-conventional-authentication").click(function() {
    $('.conventional-login').show()
    $('.social-authentication-rows').hide()
    $('#login-title').html("I hate social media! I want an old fashioned username/password")  
  });
...
$(document).ready(function() {
  ...
  $(".activate-login-modal-navbar").click(function() {
    ...
    $('.conventional-login').hide()
    $('.social-authentication-rows').show()
  });
